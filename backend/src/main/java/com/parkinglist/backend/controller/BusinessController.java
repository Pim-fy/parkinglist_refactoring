...
public class BusinessController {
    ...
    public ResponseEntity<String> registerParkingToLocation(
        ...
        // 사업자 여부 검증은 서비스 레이어의 findLocationByIdAndVerifyOwner에서 처리.
